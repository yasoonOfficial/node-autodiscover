...
var getEwsUrl = function(mailAddress, password, callback) {
  if (!mailAddress) {
...
var createAutodiscoverService = function(mailAddress, password) {
  ...
  var pickEwsUrl = function(result) {
    var protocols = result.Autodiscover.Response[0].Account[0].Protocol;
    var ewsUrl = _.find(protocols, function(protocol) {
      return protocol.Type[0] === 'EXPR';
    }).EwsUrl[0];
    return ewsUrl;
  };
